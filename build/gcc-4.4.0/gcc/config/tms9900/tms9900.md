...
(define_insn "tsthi"
  ...
  ""
  {
    tms9900_debug_operands ("tsthi", operands, 3);
    return("mov  %0, %0");
  }
  [(set_attr "length" "2,6")])
...
(define_insn "tstqi"
  ...
  ""
  {
    tms9900_debug_operands ("tstqi", operands, 3);
    return("movb %0, %0");
  }
  [(set_attr "length" "2,6")])
...
(define_insn "cmphi"
  ...
  ""
  {
    tms9900_debug_operands ("cmphi", operands, 3);
...
(define_insn "cmpqi"
  ...
  ""
  {
    tms9900_debug_operands ("cmpqi", operands, 3);
...
(define_expand "udivmodhi4"
  ...
  ""
  {
    ...
    /*  MGB this expand generates a zero_extendqihi2 - HOW??  If this could be
