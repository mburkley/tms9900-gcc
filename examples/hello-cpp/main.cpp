 ...
 *                                 show
 *==========================================================================
 * Description: Display the text for this class at a specified location on the screen
 *
 ...
 * Returns    : Nothing
 */
void Word::show(int row, int column)
{
  unsigned int size;    /* Size of text string to display */
  unsigned int offset;  /* Offset into screen buffer */
...
/* Class instances used by the main loop */
Word word( (char*)"HELLO");
Word blank((char*)"     ");
