...
(define_expand "cmp<mode>"
  ...
  ""
  {
    ...
    if (GET_CODE (operands[1]) == CONST_INT)
    {
      ...
      {
        emit_insn (gen_tms9900_cmpimmed (operands[0], operands[1]));
      }
      else
      {
    ...
    if (GET_MODE (operands[0]) == QImode)
      emit_insn (gen_tms9900_cmpqi (operands[0], comp));
    else
      emit_insn (gen_tms9900_cmphi (operands[0], comp));
    DONE;
  })

(define_insn "tms9900_cmpimmed"
  [(set (reg:CC CC_REGNUM)
        (compare:CC (match_operand:QI 0 "nonimmediate_operand" "r")
...
(define_expand "truncsiqi2"
  ...
  ""
  {
    ...
    emit_insn (gen_truncsihi2 (operands[0], operands[1]));
    emit_insn (gen_trunchiqi2 (operands[0], operands[1]));
    DONE;
  }
)
