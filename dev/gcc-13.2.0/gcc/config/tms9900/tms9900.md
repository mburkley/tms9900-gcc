...
(define_expand "cmpqi_immed"
  ...
  ""
  {
    ...
    if (GET_CODE (operands[1]) == CONST_INT)
    {
        ...
        emit_insn (gen_movhi (operands[2], GEN_INT (val<<8)));
        emit_insn (gen_cmpqi_non_immed (operands[0], operands[2]));
    }
    else
