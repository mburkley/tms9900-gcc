...
(define_split 
  ...
  [(set (match_dup 3) (match_dup 2))
   (set (match_dup 0) (compare:CC (match_dup 1) (match_dup 3)))]
  "")
...
;         emit_insn (gen_movqi_cc (tmp, operands[1]));
;         emit_insn (gen_cmpqi_non_immed (operands[0], tmp));
;     }
;     else
;     {
;         // TODO isn't this unreachable?
;         printf ("** compqi immed, op1 isn't const?\n");
;         emit_insn (gen_cmpqi_non_immed (operands[0], operands[1]));
;     }
; 
;     DONE;
;   })
