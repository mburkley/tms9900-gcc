...
(define_insn "call_value"
  ...
  ""
  {
    tms9900_debug_operands ("call_value", operands, 4);
    return("bl   %1");
  }
  [(set_attr "length" "2,4")]
)
...
(define_insn "sibcall"
  ...
  ""
  {
    tms9900_debug_operands ("sibcall", operands, 3);
    return("b    %0");
  }
  [(set_attr "length" "2,4")]
)
...
(define_insn "sibcall_value"
  ...
  ""
  {
    tms9900_debug_operands ("sibcall_value", operands, 4);
    return("b    %1");
  }
  [(set_attr "length" "2,4")]
)
...
(define_expand "tms9900_cmpqi_immed"
  [(set (reg:CC CC_REGNUM)
        (compare:CC (match_operand:QI 0 "nonimmediate_operand" "")
                    (match_operand:QI 1 "immediate_operand" "")))]
  ""
  {
    tms9900_debug_operands ("tms9900_cmpqi_immed", operands, 2);
    rtx tmp = gen_reg_rtx (QImode);
    emit_insn (gen_tms9900_movqi_const (tmp, operands[1]));
    emit_insn (gen_tms9900_cmpqi (operands[0], tmp));
    DONE;
  }
)
...
;; Native compare for non immediates. Emit C or CB
...
;; stupid.  Make it an alternative with 0 length
