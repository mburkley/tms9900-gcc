...
;;-------------------------------------------------------------------
;; Move byte value strict - must preserve other part of reg TODO
(define_insn "movstrictqi"
  [(set (match_operand:QI 0 "nonimmediate_operand" "=rR>,  Q,rR>,Q,r")
        (match_operand:QI 1 "general_operand"       "rR>,rR>,  Q,Q,i"))]
  ""
  {
    tms9900_debug_operands ("movqistrict", operands, 2);
    // tms9900_register_convert (operands[1], QImode, 0);
    // tms9900_register_mode_set (operands[0], QImode);
    int val;
    if (which_alternative < 4)
...
;; Multiply
;;
;; We can't support mulhisi because it will generate an insn with 3 operands
;; since op0 is SI and op1/op2 are HI but on TMS9900 mpy takes only two operands.
;;-------------------------------------
