...
(define_insn "zero_extendqihi2"
  [(set (match_operand:HI 0 "register_operand" "=r,r,r")
	(zero_extend:HI (match_operand:QI 1 "register_operand" "0,R,Q")))]
  ""
  {
...
(define_insn "andhi3"
  ...
  ""
  {
    ...
    // REG_OFFSET doesn't work in gcc13 - will have to find another way

    // if (REG_OFFSET (operands[1]).to_constant() == -1)
    //     output_asm_insn("swpb %0", operands);
