...
*                               __ashlsi3
*******************************************************************************
* Arith left shift a 32-bit value.  Parameter order is unknown, making an
* assumption to be tested.  Hopefully shift count is loaded into R0
*
* Inputs : [R1,R2] - Value to shift
*          [R0]    - shift count
*
* Returns: [R1,R2] - result
*******************************************************************************/
#ifdef L_ashlsi3
/*********************************************************/
/*                     __ashlsi3                          */
