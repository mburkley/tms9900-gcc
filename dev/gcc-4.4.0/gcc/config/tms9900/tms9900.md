...
(define_expand "prologue"
  ...
  ""
{
  tms9900_debug_operands ("prologue", NULL, 0);
...
(define_expand "epilogue"
  ...
  ""
{
  tms9900_debug_operands ("epilogue", NULL, 0);
...
(define_expand "sibcall_epilogue"
  ...
  ""
{
  tms9900_debug_operands ("sibcall_epilogue", NULL, 0);
...
(define_insn "zero_extendqihi2"
  [(set (match_operand:HI 0 "register_operand" "=r,r,r")
	(zero_extend:HI (match_operand:QI 1 "nonimmediate_operand" "r,R,Q")))]
  ""
  {
    tms9900_debug_operands ("zero_extendqihi2", operands, 2);

    if (which_alternative > 0 || REGNO(operands[0])!=REGNO(operands[1]))
    {
...
(define_insn "extendqihi2"
  [(set (match_operand:HI 0 "register_operand" "=r,r,r")
	(sign_extend:HI (match_operand:QI 1 "register_operand" "r,R,Q")))]
  ""
  {
...
(define_insn "ashlhi3"
  ...
  ""
  {
    ...
    if(which_alternative == 0)
    {
      ...
      output_asm_insn("mov  r0, r0",   operands);
...
(define_insn "andhi3"
  ...
  ""
  {
    ...
    if(which_alternative >= 4)
    {
      ...
      // TODO move 0 and -1 to separate constraint classes to fix up the length
      if(val == 0)
      {
        /* Result will be zero */
