...
(define_expand "cmphi"
  ...
  ""
  {
     ...
     *  compare to a literal than load an immediate to a reg and compare to the
     *  reg */
...
(define_peephole2
  ...
  [(set (cc0) 
        (compare (match_dup 2)
                 (match_dup 1)))]
  {
    tms9900_debug_operands ("peep-cmp", NULL_RTX, operands, 3);
  }
)
...
(define_peephole2
  ...
  [(set (cc0) 
        (compare (match_dup 2)
                 (match_dup 1)))]
  {
    tms9900_debug_operands ("peep-cmpb", NULL_RTX, operands, 3);
  }
)
...
(define_expand "cmpqi"
  ...
  ""
  {
    ...
    {
      tms9900_inline_debug ("; cmpqi replace const with label\n");
      operands[1] = force_const_mem (QImode, GEN_INT (INTVAL (operands[1]) & 0xff));
    }

    emit_insn (gen_tms9900_cmpqi (operands[0], operands[1]));
    DONE;
  }
)
