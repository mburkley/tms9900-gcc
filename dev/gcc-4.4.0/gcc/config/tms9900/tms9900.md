...
(define_insn "tms9900_subqi3"
  [(set (match_operand:QI 0 "nonimmediate_operand"           "=rR>,Q,  rR>,Q,r,  r,R>, Q,  R>,Q")
	(minus:QI (match_operand:QI 1 "nonimmediate_operand" "0,   0,  0,  0,rR>,Q,rR>,rR>,Q, Q")
		  (match_operand:QI 2 "nonimmediate_operand" "rR>, rR>,Q,  Q,0,  0,0,  0,  0, 0")))]
  ""
  {
    ...
    else if (which_alternative < 6)
    {
      ...
      // TODO are there cases where random data in the low byte will affect the negation?
      output_asm_insn("neg  %0",operands);
    }
    else
    {
  ...
  [(set_attr "length" "2,4,4,6,4,6,8,12,10,14")])
