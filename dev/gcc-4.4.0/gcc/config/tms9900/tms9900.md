...
(define_expand "movsi"
  ...
  ""
  {
    ...
    {
      args[0] = gen_lowpart(HImode, operands[1]);
      args[1] = gen_highpart(HImode, operands[1]);
    }
    emit_move_insn (gen_lowpart (HImode, operands[0]), args[0]);
    emit_move_insn (gen_highpart (HImode, operands[0]), args[1]);
    DONE;
  })
...
;;-------------------------------------
;
; Byte fetch from packed structure
;
; Replace:
;   movb @x, r1
;   sla  r1, 8
...
(define_peephole2
  [(set (match_operand:QI 0 "register_operand" "")
   ...
   (set (match_operand:HI 5 "register_operand" "")
        (ior (match_dup 5) (match_dup 2)))]       
  ""
  [(set (match_dup 0) (match_dup 4))
   (set (match_dup 2) (truncate:QI (match_dup 2)))
  ...
  [(set (match_dup 6)
   ...
   (set (match_dup 6)
        (ashiftrt:QI (match_dup 6)
                     (match_dup 5)))]
  {
    tms9900_debug_operands ("peep-ashri", NULL_RTX, operands, 8);
  }
)
