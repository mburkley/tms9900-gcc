...
(define_insn "cmpqi"
  [(set (cc0)
	(compare (match_operand:QI 0 "nonimmediate_operand" "=rR>,rR>,Q,  Q,r")
		 (match_operand:QI 1 "general_operand"       "rR>,Q,  rR>,Q,i")))]
  ""
  {
    if (which_alternative == 4)
    {
      if (!find_regno_note (insn, REG_DEAD, REGNO (operands[0])))
      {
        printf ("** cmpqi to const but target not dead, so ......\n");
        gcc_unreachable();
      }
...
(define_insn "tms9900_movhi"
  ...
  ""
  {
    ...
    // bool postByteSwap = tms9900_correct_byte_order (insn, operands, 2);
...
(define_insn "andhi3"
  ...
  ""
  {
     ...
     * arise.
     */
    // tms9900_correct_byte_order (insn, operands, 3);
...
(define_insn "one_cmplhi2"
  ...
  ""
  {
    ...
    // tms9900_correct_byte_order (insn, operands, 2);
    return "inv  %0";
  }
  [(set_attr "length" "2,4")])
...
(define_insn_and_split "addhi3"
  [(set (match_operand:HI 0 "nonimmediate_operand"          "=r, r,r,rR>,Q,  R>, R>,Q,  Q")
	(plus:HI (match_operand:HI 1 "nonimmediate_operand" "%0, 0,0,0,  0,  0,  0, 0,  0")
		 (match_operand:HI 2 "general_operand"      "rR>,Q,i,LMN,LMN,rR>,Q, rR>,Q")))]
  ""
  {
    ...
    case 1:
      ...
      if (tms9900_operand_subreg_offset (operands[2]))
      {
      ...
      if (tms9900_operand_subreg_offset (operands[1]))
      {
